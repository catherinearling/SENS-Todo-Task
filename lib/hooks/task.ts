...
export function useCheckTask(args: { operation: PolicyCrudKind; where?: { id?: string; title?: string; description?: string; ownerId?: string; spaceId?: string }; }, options?: QueryOptions<boolean>) {
